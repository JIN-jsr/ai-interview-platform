...
> 本文件用于 GitHub 在线阅读；正式固定排版与提交版本以同目录下的 PDF `Project_Design_Document.pdf` 为准。
...
界面保持黑白灰风格，首页提供“系统介绍”和“模拟面试”入口。系统介绍页说明平台定位、工作流程、技术特色和使用边界；模拟面试页聚焦当前问题、问题详情、回答提交、报告跳转和状态展示。
