...
-> LLM + RAG 协同出题 -> 连续追问 -> 回答分析
-> 五维度评分报告 -> 多格式导出 -> 能力成长复盘
```
...
图 3 评分报告仪表盘，展示总分、等级、五维能力、问题分布和稳定性分析。

![报告摘要海报导出示例](docs/assets/report_summary_poster.png)

图 4 系统生成的报告摘要海报 PNG。完整长图示例可查看：[完整报告长图 PNG](docs/assets/report_full_long.png)。
